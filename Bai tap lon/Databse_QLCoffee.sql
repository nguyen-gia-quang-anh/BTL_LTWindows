...
insert into HOADON (MHD,NgayLapHD,MNV,TongTien)
values ('HD02','3/7/2024','NV01', 1000000)

insert into HOADON (MHD,NgayLapHD,MNV,TongTien)
values ('HD03','3/8/2024','NV01', 1000000)
insert into HOADON (MHD,NgayLapHD,MNV,TongTien)
values ('HD04','3/7/2024','NV02', 100000)
insert into HOADON (MHD,NgayLapHD,MNV,TongTien)
values ('HD05','3/7/2024','NV01', 10000000)

insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD05','SP01','1', 10000000,10000000)

insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD05','SP02','1', 10000000,10000000)
insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD05','SP03','1', 10000000,10000000)

insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD01','SP03','1', 10000000,10000000)

insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD01','SP06',4,35000,140000)
insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD01','SP05',10,200000,2000000)
insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD01','SP09',10,40000,400000)
insert into CHITIETHOADON (MHD,MAP,SL,Gia,ThanhTien)
values ('HD01','SP02',5,40000,200000)
SELECT QLSP.TenP, SUM(CHITIETHOADON.ThanhTien) AS TongThanhTien
FROM CHITIETHOADON
JOIN QLSP ON CHITIETHOADON.MAP = QLSP.MAP
JOIN HOADON ON CHITIETHOADON.MHD = HOADON.MHD
WHERE YEAR(HOADON.NgayLapHD) = 2024
GROUP BY QLSP.TenP;
SELECT SUM(CHITIETHOADON.ThanhTien) AS TongTien
FROM CHITIETHOADON
JOIN QLSP ON CHITIETHOADON.MAP = QLSP.MAP
JOIN HOADON ON CHITIETHOADON.MHD = HOADON.MHD
WHERE YEAR(HOADON.NgayLapHD) = 2024
AND QLSP.Loai = N'Đồ ăn';
SELECT QLSP.TenP, SUM(CHITIETHOADON.ThanhTien) AS TongThanhTien FROM CHITIETHOADON JOIN QLSP ON CHITIETHOADON.MAP = QLSP.MAP JOIN HOADON ON CHITIETHOADON.MHD = HOADON.MHD WHERE YEAR(HOADON.NgayLapHD) = 2024 AND QLSP.Loai = N'Đồ ăn' GROUP BY QLSP.TenP
